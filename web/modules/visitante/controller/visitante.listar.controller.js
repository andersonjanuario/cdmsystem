(function () {
    ...
    .controller('VisitanteListarController', VisitanteListarController);

    VisitanteListarController.$inject = ['$scope','VisitanteService','VisitanteFactory','$state'];


    function VisitanteListarController($scope, VisitanteService,VisitanteFactory,$state) {
        //Atributos
        var vm = this;
        ...
        function findByFilter(skipIn, takeIn, pesquisa, order, sort) {
            VisitanteService.findByFilter(skipIn, takeIn,pesquisa, order, sort).then(function onSuccess(response) {
                ...
                vm.visitantes = VisitanteFactory.convertList(response.data);                
            }).catch(function onError(response) {
                console.log(response);
            });
        };
